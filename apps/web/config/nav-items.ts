export const navItems = {
  header: [
    ...
    { label: "Components", href: "/docs/components/alert" },
  ...
  navMain: [
    {
      ...
      items: [
        ...
        { title: "Chart", url: "/docs/components/chart", new: true },
        { title: "Checkbox", url: "/docs/components/checkbox" },
        { title: "Combo Box", url: "/docs/components/combo-box", new: true },
        { title: "Command", url: "/docs/components/command", new: true },
        ...
        { title: "Pagination", url: "/docs/components/pagination", new: true },
        ...
        { title: "Resizable", url: "/docs/components/resizable", new: true },
        { title: "Switch", url: "/docs/components/switch" },
        { title: "Table", url: "/docs/components/table" },
        { title: "Tabs", url: "/docs/components/tabs", new: true },
