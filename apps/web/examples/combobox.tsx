...
export function ComboBoxExample() {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger
        className="flex w-auto items-center justify-between rounded-none border border-input bg-background px-3 py-2 text-sm hover:bg-accent hover:text-accent-foreground md:w-[320px] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0"
        aria-expanded={open}
      >
        {value
